...
function BodyReader(options) {
    ...
    var styleHook = options.styleHook || function() {};
    ...
    function readParagraphProperties(paragraph, element) {
        return readParagraphStyle(element).map(function(style) {
            return {
                ...
                extraStyle: styleHook ? styleHook(paragraph, element) : ''
            };
        });
    }
    ...
    function readRunProperties(run, element) {
        return readRunStyle(element).map(function(style) {
            ...
            return {
                ...
                extraStyle: styleHook ? styleHook(run, element) : ''
            };
        });
    }
    ...
    var xmlElementReaders = {
        "w:p": function(element) {
            ...
            if (isDeleted) {
                ...
                return ReadResult.map(
                    readParagraphProperties(element, paragraphPropertiesElement),
        ...
        "w:r": function(element) {
            return ReadResult.map(
                readRunProperties(element, element.firstOrEmpty("w:rPr")),
    ...
    function readTable(element) {
        var propertiesResult = readTableProperties(element, element.firstOrEmpty("w:tblPr"));
        return readXmlElements(element.children)
    ...
    function readTableProperties(table, element) {
        return readTableStyle(element).map(function(style) {
            return {
                styleId: style.styleId,
                styleName: style.name,
                extraStyle: styleHook ? styleHook(table, element) : ''
            };
        });
    }
    ...
    function readTableRow(element) {
        ...
        return readXmlElements(element.children).map(function(children) {
            return documents.TableRow(children, {
                isHeader: isHeader,
                extraStyle: styleHook ? styleHook(element, properties) : ''
            });
        });
    }
    ...
    function readBlip(element, blip) {
        ...
        if (blipImageFile === null) {
            ...
            return readImage(blipImageFile, altText, element);
        }
    }
    ...
    function readImage(imageFile, altText, element) {
        ...
        var image = documents.Image({
            ...
            extraStyle: styleHook ? styleHook(element, element) : ''
        });
